    ...
    app.innerHTML = `
        <nav class="top-nav">
            ...
            <ul class="nav-links">
                ...
                <li><a href="receipt.html">تحصيل من عميل</a></li>
                <li><a href="payment.html" class="active">سداد لمورد</a></li>
                <li class="dropdown">
                    <a href="#">التقارير</a>
                    <div class="dropdown-content">
        ...
        <div class="content">
            <div class="page-header">
                <h1 class="page-title" style="margin-bottom: 20px; color: var(--primary-color);">سداد نقدية لمورد</h1>
            </div>
...
async function loadSuppliers() {
    try {
        ...
        const validSuppliers = customers.filter(c => c.type === 'supplier' || c.type === 'both');
        
        validSuppliers.forEach(c => {
...
function setupEventListeners() {
    document.getElementById('paymentForm').addEventListener('submit', async (e) => {
        ...
        const data = {
            ...
            customer_id: document.getElementById('supplier').value, // Using customer_id field for supplier too as they are in same table
            amount: parseFloat(document.getElementById('amount').value),
            description: document.getElementById('description').value || 'سداد نقدية'
        };
